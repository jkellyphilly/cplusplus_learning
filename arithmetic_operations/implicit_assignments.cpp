...
int main() {
    ...
    std::cout<<"a = "<<a<<"\n";
    // interesting - 65 must be the ASCII value for
    // capital A, so passing an integer for type character has
    // the compiler interpret the character by numerical reference
    ...
    floatNumber = charB; // once again - the ASCII valuel is 66
